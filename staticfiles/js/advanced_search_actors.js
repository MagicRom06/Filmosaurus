$("#button_search_casting").click(function(){
    let search = $("#input_for_casting").val();
    $(".row_advanced_results").remove();
    $("#advanced_results").append("<div id='rainbow_loader' class='rainbow mt-5'></div>")
    $.ajax({
        url: '/movies/advanced/search/results?by_casting=' + search,
        type: 'get',
